...
export const query = {"Query":{"objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"objectTypeName":"Root","selection":{"canCreateResolutions":{"fieldArguments":{},"fieldQuery":null},"isDeveloper":{"fieldArguments":{},"fieldQuery":null},"isDefaultTierEnabled":{"fieldArguments":{},"fieldQuery":null},"impersonateWalletAddress":{"fieldArguments":{},"fieldQuery":null}}}}}}}};
...
export const vercelFlagDefinitions = {"canCreateResolutions":{"options":[{"value":true},{"value":false}],"origin":"https://app.hypertune.com/projects/3217/draft?view=logic&selected_field_path=root%3EcanCreateResolutions"},"isDeveloper":{"options":[{"value":true},{"value":false}],"origin":"https://app.hypertune.com/projects/3217/draft?view=logic&selected_field_path=root%3EisDeveloper"},"isDefaultTierEnabled":{"options":[{"value":true},{"value":false}],"origin":"https://app.hypertune.com/projects/3217/draft?view=logic&selected_field_path=root%3EisDefaultTierEnabled"}};
...
const rootFallback = {canCreateResolutions:false,isDeveloper:false,isDefaultTierEnabled:false,impersonateWalletAddress:""};
...
const queryFallback = {root:{canCreateResolutions:false,isDeveloper:false,isDefaultTierEnabled:false,impersonateWalletAddress:""}};
