...
export interface ShareholderRegistryInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "batchTransferFromDAO", values: [PromiseOrValue<string>[]]): string;
  ...
  decodeFunctionResult(functionFragment: "batchTransferFromDAO", data: BytesLike): Result;
...
export interface ShareholderRegistry extends BaseContract {
  ...
  callStatic: {
    ...
    batchTransferFromDAO(recipients: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;
