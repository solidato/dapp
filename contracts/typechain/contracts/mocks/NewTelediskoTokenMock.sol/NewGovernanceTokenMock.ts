...
export interface NewGovernanceTokenMockInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "setTokenExternal", values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "tokenExternal", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "setTokenExternal", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "tokenExternal", data: BytesLike): Result;
...
export type VestingSet2Event = TypedEvent<[string, string, BigNumber], VestingSet2EventObject>;

export type VestingSet2EventFilter = TypedEventFilter<VestingSet2Event>;

export interface NewGovernanceTokenMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NewGovernanceTokenMockInterface;
  ...
  functions: {
    ...
    setTokenExternal(
      tokenExternalAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
    ...
    tokenExternal(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setRedemptionController(redemption: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    setRoles(roles: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    setTokenExternal(tokenExternalAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "VestingSet2(address,address,uint256)"(from?: null, to?: null, amount?: null): VestingSet2EventFilter;
  ...
  estimateGas: {
    ...
    tokenExternal(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    tokenExternal(overrides?: CallOverrides): Promise<PopulatedTransaction>;
