...
export interface GovernanceTokenV2MockInterface extends utils.Interface {
  functions: {
...
export interface GovernanceTokenV2Mock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceTokenV2MockInterface;
