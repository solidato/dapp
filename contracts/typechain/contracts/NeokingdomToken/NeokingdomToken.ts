...
export interface NeokingdomTokenInterface extends utils.Interface {
  functions: {
...
export interface NeokingdomToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NeokingdomTokenInterface;
