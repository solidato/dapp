...
export interface INeokingdomTokenInterface extends utils.Interface {
  functions: {
...
export interface INeokingdomToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: INeokingdomTokenInterface;
