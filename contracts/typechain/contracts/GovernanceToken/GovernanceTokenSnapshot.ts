...
export interface GovernanceTokenSnapshotInterface extends utils.Interface {
  functions: {
...
export interface GovernanceTokenSnapshot extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceTokenSnapshotInterface;
