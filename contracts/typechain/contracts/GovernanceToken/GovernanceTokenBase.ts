...
export interface GovernanceTokenBaseInterface extends utils.Interface {
  functions: {
...
export interface GovernanceTokenBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceTokenBaseInterface;
