...
import ProjectCard from "@components/vanilla/tasks/ProjectCard";
import TaskDialog from "@components/vanilla/tasks/TaskDialog";
import TaskForm from "@components/vanilla/tasks/TaskForm";
...
export default function Tasks() {
  ...
  const { data: projects, error, mutate, isLoading } = useSWR<Project[]>("/api/tasks?vanilla=true", fetcher);
