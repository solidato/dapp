...
export default function useResolutionsAcl(address = ""): { acl: ResolutionsAcl; error?: boolean; isLoading?: boolean } {
  const { data, error, isLoading } = useSWR(getDaoManagerQuery, fetcher);
